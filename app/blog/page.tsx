...
export default async function BlogPage() {
	...
	return (
		<div className="relative pb-16 bg-gradient-to-tr to-blue-500 from-green-500">
			<Navigation />
			<div className="px-6 pt-16 mx-auto space-y-8 max-w-7xl lg:px-8 md:space-y-16 md:pt-24 lg:pt-32">
				...
				<div className="w-full h-px to-blue-500" />
				...
				<div className="hidden w-full h-px md:block to-blue-500" />
